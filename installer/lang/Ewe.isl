...
LdrCannotCreateTemp=Mete ŋu ʋu fite (file, fichier) sẽetɔ aɖeke o. Edzudzɔ edadaɖi LdrCannotExecTemp=Mete ŋu ʋu fite aɖeke le akploe (folder, dossier) sẽetɔ me o. Edzudzɔ edadaɖi
HelpTextNote=

; *** Startup error messages
LastErrorMessage=%1.%n%nKuxi %2: %3
SetupFileMissing=Fite %1 mele nunɔƒea (directory) o. Taflatsɛ ɖɔ kuxi sia ɖo, alo zã daɖinu yeye.
SetupFileCorrupt=Nu si woda ɖi gblẽ. Taflatsɛ zã bubu.
SetupFileCorruptOrWrongVer=Daɖinu la gblẽ, alo menye nyuitɔ o Taflatsɛ ɖɔ kuxi sia ɖo, alo zã daɖinu yeye.
...
WindowsServicePackRequired=Dɔwɔnu sia hiã %1 Service Pack %2 alo yeyetɔwo.
...
WinVersionTooLowError=Dɔwɔnu sia hiã %1 wɔwɔ %2 alo yeyetɔwo.
WinVersionTooHighError=Mate ŋu ada dɔwɔnu sia ɖe %1 wɔwɔ %2 alo yeyetɔwo dzi o.
AdminPrivilegesRequired=Ele be nàɖo eme abe dzikpɔla ene hafi ate ŋu ada dɔwɔnu sia ɖi.
PowerUserPrivilegesRequired=Ele be nàɖo eme abe dzikpɔla alo Ezãla Kpɔŋusẽwo ƒe ha me tɔ ene hafi ate ŋu ada dɔwɔnu sia ɖi.
SetupAppRunningError=Daɖinu la kpɔe be %1 le dɔ wɔm.%n%nTaflatsɛ tu bubuawo katã eye nàzi Yoo dzi ne wòayi edzi, alo nàzi Tasii dzi, ne wòatu.
UninstallAppRunningError=Eɖeɖeɖa kpɔe be %1 le dɔ wɔm fifia.%n% Taflatsɛ tu bubuawo katã eye nàzi Yoo dzi ne wòayi edzi, alo nàzi Tasii dzi, ne wòatu.

; *** Startup questions
PrivilegesRequiredOverrideTitle=Tia Edadaɖi Ƒe Mɔnu
PrivilegesRequiredOverrideInstruction=Tia edadaɖi ƒe mɔnu
PrivilegesRequiredOverrideText1=Woate ŋu ada %1 ɖi na ezãlawo katã (ahiã dzikpɔla ƒe ŋusẽ), alo adae ɖi na wò ɖeka ko.
PrivilegesRequiredOverrideText2=Ate ŋu ada %1 ɖi na wò ɖeka, alo na ezãlawo katã (ahiã dzikpɔla ƒe ŋusẽ).
PrivilegesRequiredOverrideAllUsers=Dae ɖi &na ezãlawo katã
PrivilegesRequiredOverrideAllUsersRecommended=Dae ɖi &na ezãlawo katã (wokafui)
...
ExitSetupMessage=Daɖinua mewu dɔ nu o. Ne ètui fifia la, mada dɔwɔnua ɖi o.%n%nÀte ŋu adze Daɖinua gɔme ake ɣebuɣi ne wòawu edadaɖi nu.%n%nNètu Daɖinua?
AboutSetupMenuItem=&Tso Daɖinua Ŋu...
AboutSetupTitle=Tso Daɖinua Ŋu
AboutSetupMessage=%1 wɔwɔ %2%n%3%n%n%1 gɔmedzeƒe:%n%4
AboutSetupNote=
TranslatorNote=Apeviekou Komlan kple Madeleine Apeviekou ye ɖe egɔme (apequm@gmail.com).
...
ButtonCancel=Tasii
ButtonYes=&Ɛ̃
ButtonYesToAll=Ɛ̃ na &wo katã
ButtonNo=A&o
ButtonNoToAll=A&o na wo katã
ButtonFinish=&Nekpa
...
SelectLanguageLabel=Tia gbegbɔgblɔ si woazã le edadaɖi me.

; *** Common wizard text
ClickNext=Zi Ŋgɔgbe dzi, ne nàyi edzi, alo zi Tasii dzi ne Daɖinua natu.
BeveledLabel=
BrowseDialogTitle=Tsa Eme Nàkpɔ Akploea
BrowseDialogLabel=Tia akploea le esiwo le dzedzem dome, eye nàzi Yoo dzi.
NewFolderName=Akploe Yeye

; *** "Welcome" wizard page
WelcomeLabel1=Wòe Zɔ, [name] Daɖinu Lae Nye Esi
WelcomeLabel2=Ada [name/ver] ɖe wò adaŋudemɔ dzi.%n%nWokafui be nàtsi dɔwɔnu bubuwo katã hafi ayi edadaɖi dzi.
...
WizardLicense=Ezazã Ƒe Ɖoɖo
LicenseLabel=Nyatakaka siwo gbɔna le vevie ŋutɔ. Taflatsɛ xlẽ wo hafi nàyi edzi.
LicenseLabel3=Taflatsɛ xlẽ ezazã ƒe ɖoɖo si gbɔna. Ele be nàlɔ̃ ɖe ɖoɖoa katã dzi hafi ate ŋu ada dɔwɔnu sia ɖi.
LicenseAccepted=&Melɔ̃ ɖe ɖoɖoa dzi
LicenseNotAccepted=N&yemelɔ̃ ɖe ɖoɖoa dzi o

; *** "Information" wizard pages
WizardInfoBefore=Nyatakaka
InfoBeforeLabel=Taflatsɛ xlẽ nyatakaka vevi sia hafi nàyi edzi.
InfoBeforeClickLabel=Ne èsɔ gbe be Daɖinua nayi edzi la, ke zi Ŋgɔgbe dzi.
WizardInfoAfter=Nyatakaka
InfoAfterLabel=Taflatsɛ xlẽ nyatakaka vevi sia hafi nàyi edzi.
InfoAfterClickLabel=Ne èsɔ gbe be Daɖinua nayi edzi la, ke zi Ŋgɔgbe dzi.

; *** "User Information" wizard page
WizardUserInfo=Ezãla Ŋuti Nyatakaka
UserInfoDesc=Taflatsɛ ŋlɔ wò nyatakakawo.
UserInfoName=E&zazãŋkɔ:
UserInfoOrg=&Habɔbɔ:
UserInfoSerial=&Xexlẽdzesi:
...
DiskSpaceGBLabel=Disk ƒe lolome [gb] GB teti ya hiã.
DiskSpaceMBLabel=Disk ƒe lolome [mb] MB teti ya hiã.
...
InvalidPath=Ele be nàŋlɔ zɔƒe blibo la katã; le kpɔɖeŋu me:%n%nC:\APP%n%nke menye esi gbɔna o:%n%n\\server\share
...
DiskSpaceWarning=Daɖinua hiã %1 KB hafi ate ŋu adae ɖi, gake %2 KB koe le daɖoƒe si nètia dzi.%n%nÈdi be neyi edzi nenema koa?
...
DirExists=Akploe:%n%n%1%n%nli xoxo. Àdi be nedae ɖe akploe ma me kokokoa?
DirDoesntExistTitle=Akploea Meli O
DirDoesntExist=Akploe:%n%n%1%n%nmeli o. Àdi be newɔ akploe bubua?

; *** "Select Components" wizard page
WizardSelectComponents=Emenuwo Tiatia
SelectComponentsDesc=Emenu kawoe nàdi be yeatia?
SelectComponentsLabel2=Tia emenu siwo nèdi be yeada ɖi; ɖe asi le esiwo mèdi be wòanɔ eme o la ŋu. Zi Ŋgɔgbe dzi ne èsɔ gbe ayi edzi.
...
NoUninstallWarning=Daɖinua kpɔe be emenu siawo le wò adaŋudemɔa dzi xoxo:%n%n%1%n%nEdzizizi be megatia emenu siawo o maɖe wo ɖa o.%n%nÀdi be neyi edzi kokokoa?
ComponentSize1=%1 KB
ComponentSize2=%1 MB
ComponentsDiskSpaceGBLabel=Tiatia fifitɔ hiã disk ƒe lolome [gb] GB ya teti.
ComponentsDiskSpaceMBLabel=Tiatia fifitɔ hiã disk ƒe lolome [mb] MB ya teti.
...
SelectStartMenuFolderBrowseLabel=Zi Ŋgɔgbe dzi nàyi edzi. Ne èdi be yeatia akploe bubu la, zi Tsa Eme dzi.
...
ReadyLabel2b=Zi Dae Ɖi dzi ne nàyi edadaɖi dzi.
ReadyMemoUserInfo= Ezãla Ŋuti Nyatakaka:
ReadyMemoDir=Nunɔƒe:
...
StopDownload=Èdi be netɔ ehehe ŋutɔŋutɔa?
...
StopExtraction=Èdi be netɔ eɖeɖe ŋutɔŋutɔa?
...
PreviousInstallNotCompleted=Dɔwɔnu xoxoa dada ɖi/ɖeɖe ɖa wu enu. Ahiã be nàgbugbɔ dze wò adaŋudemɔa gɔme be tɔtrɔ sia nawɔ dɔ.%n%nNe wò adaŋudemɔa gbugbɔ dze egɔme la, gbugbɔ dze Daɖinu la hã gɔme ne wòagada [name] ɖi.
CannotContinue=Daɖinua mate ŋu ayi edzi o. Taflatsɛ zi Tasii dzi ne wòatu.
ApplicationsFound=Dɔwɔnu siawo le fite siwo wòle be Daɖinu natrɔ yeyee la zãm. Míekafui be nàɖe mɔ na Daɖinu la be wòatu dɔwɔnu siawo le eɖokui si.
ApplicationsFound2= Dɔwɔnu siawo le fite siwo wòle be Daɖinu natrɔ yeyee la zãm. Míekafui be nàɖe mɔ na Daɖinu la be wòatu dɔwɔnu siawo le eɖokui si. Ne Daɖinua da dɔwɔnua ɖi vɔ la, atee kpɔ be yeagbugbɔ dɔwɔnu mawo aʋu.
CloseApplications=Net&u dɔwɔnuawo le eɖokui si
DontCloseApplications=Mègat&u dɔwɔnuawo o
ErrorCloseApplications=Daɖinu la mete ŋu tu dɔwɔnuawo katã le eɖokui si o. Míekafui be nàtu dɔwɔnu siwo katã le fite siwo wòle be Daɖinu la natrɔ yeyee la zãm la hafi ayi edadaɖi dzi.
PrepareToInstallNeedsRestart=Daɖinu agbugbɔ wò adaŋudemɔ gɔme adze. Ne ewɔ esia vɔ la, gadze Daɖinua gɔme ake ne wòada [name] ɖi.%n%Àdi be yeagbugbɔ adze adaŋudemɔa gɔme fifia?
...
FinishedLabel=Daɖinu la da [name] ɖe wò adaŋudemɔ dzi vɔ. Àte ŋu aʋu dɔwɔnua ne èzi kpuiƒedzesia dzi.
ClickFinish=Zi Wu Enu dzi ne Daɖinu la natu.
FinishedRestartLabel=Ne èdi be yeawu [name] dada ɖi nu la, gbugbɔ dze Daɖinu la gɔme. Àdi be yeagbugbɔ dze egɔme fifia?
FinishedRestartMessage=Ne èdi be yeawu [name] dada ɖi nu la, gbugbɔ dze Daɖinu la gɔme.%n%nÀdi be yeagbugbɔ dze egɔme fifia?
ShowReadmeCheck=Ɛ̃, madi be makpɔ XLẼM ƒe fite la
...
ChangeDiskTitle=Daɖinu la hiã Disk Si Kplɔe Ɖo
SelectDiskLabel2=Taflatsɛ de Disk %1 eme eye nàzi Yoo dzi.%n%nNe fite siwo le disk sia dzi le akploe bubuwo me la, ke ŋlɔ zɔƒe kple akploe si me wòadii le.
PathLabel=&Zɔƒe:
...
SourceIsCorrupted=Fite tsoƒetɔ la gblẽ
SourceDoesntExist=Fite tsoƒetɔ "%1" meli o
ExistingFileReadOnly2=Womate ŋu aɖɔli fite la o, elabe woda xlẽe-ko ɖe edzi.
ExistingFileReadOnlyRetry=&Ɖe xlẽe-ko la le edzi eye nàgatee kpɔ
...
UninstallDisplayNameMarkAllUsers=Ezãlawo katã
UninstallDisplayNameMarkCurrentUser=Ezãla fifitɔ

; *** Post-installation errors
ErrorOpeningReadme=Kuxi aɖe va esi wòdi be yeaʋu XLẼM ƒe fite la.
ErrorRestartingComputer=Daɖinu la mete ŋu gbugbɔ dze adaŋudemɔ la gɔme o. Wò ŋutɔ wɔe.
...
ConfirmUninstall=Èdi be yeaɖe %1 kple emenuwo katã ɖa?
UninstallOnlyOnWin64= 64-bit Windows dzi ko woate ŋu aɖe daɖinu sia ɖa le.
OnlyAdminCanUninstall=Ezãla si si dzikpɔla ƒe ŋusẽ le koe ate ŋu aɖee ɖa.
...
UninstalledAndNeedsRestart=Gbugbɔ dze wò adaŋudemɔa gɔme ne wòaɖe %1 ɖa ne wòawu eɖeɖeɖa nu.%n%nÀdi be negbugbɔ dze egɔme fifia?
UninstallDataCorrupted=Fite "%1" gblẽ. Mate ŋu aɖee ɖa o

; *** Uninstallation phase messages
ConfirmDeleteSharedFileTitle=Ɖe Fite Mamawo Ɖa?
ConfirmDeleteSharedFile2=Nuɖoanyia ɖee fia be dɔwɔnu aɖeke megale fite siawo zãm o. Àdi be Ɖee Ɖa naɖe fite mamawo ɖa?%n%nNe dɔwɔnu aɖe gakpɔtɔ le fite sia zãm eye nèɖee ɖa la, womagawɔ dɔ nyuie o. Ne mèka ɖe edzi o la, tia Ao. Fite la gbegblẽ ɖe wò adaŋdemɔa dzi magblẽ naneke o.
...
AddonHostProgramNotFound=Woate ŋu akpɔ %1 le akploe si nètia la me.%n%nÈdi be neyi edzi kokokoa?
